...
#include <memory>
#include "../3DViewer_v1/glviewer.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_GLviewer_t, stringdata0) + ofs), len 
...
const QMetaObject GLviewer::staticMetaObject = { {
    ...
    qt_meta_stringdata_GLviewer.offsetsAndSize,
    qt_meta_data_GLviewer,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_GLviewer_t
