...
void MainWindow::on_openFile_clicked() {
    ...
    ui->coun_vertexes->setText(QString::number((s21::DataModel::GetInstance()->GetVertex().size() - 3) / 3));
    ui->count_facets->setText(QString::number(s21::DataModel::GetInstance()->GetFacetsSize() / 2));
